<?php
	$titrePage = "Guide d'installation de Visual Paradigm";
	include ($_SERVER['DOCUMENT_ROOT'].'/DC12015_DocumentationInstallation/php/entete.php');
?>

<div class='contenu'>

<h1>Guide d'installation de Visual Paradigm<h1>
...
<h3><a name="prealables">Préalables</a></h3>
    <ul>
		<li>Intel Pentium 4 à 2.0 GHz ou plus récent</li>
		<li>Minimum 2.0 GB RAM, mais 4.0 GB est recommandé.</li>
...
<h3><a name="linux-installation">Procédure d'installation</a></h3>
	<p>Ouvrer un terminal dans le dossier où se situe le fichier d'installation de Visual Paradigm et entrer la commande suivante:</p>
	<p class="terminal">bash ./NOM_DU_FICHIER/</p>
	<p>Cliquer sur <i>Next</i>.</p>
	<img alt="Bienvenue" src="../ressources/images/visualParadigm/linux/linux_bienvenue.png"/>
	<p>Lire l'accord de liscence et sélectionner <i>I accept the agreement</i> ensuite cliquer sur <i>Next</i>.</p>
	<img alt="Accord de liscence" src="../ressources/images/visualParadigm/linux/linux_liscence.png"/>
	<p>Sélectionner le répertoire de destination à l'aide du bouton <i>Browse</i>. Une fois le répertoire choisi cliquer sur <i>Next</i>.</p>
	<img alt="Choix du répertoire" src="../ressources/images/visualParadigm/linux/linux_repertoire.png"/>
	<p>Attendre la fin de l'installation.</p>
	<img alt="Installation" src="../ressources/images/visualParadigm/linux/linux_installation.png"/>
	<p>Sélectionner l'option <i>Visual Paradigm 12.0</i> si vous voulez démarrer Visual Paradigm suite à la fermeture de l'installateur, sinon sélectionner <i>Don't start</i>. Cliquer sur <i>Finish</i>.</p>
	<img alt="Démarage" src="../ressources/images/visualParadigm/linux/linux_demarrage.png"/>
	<p>Entrer votre nom dans le champs <i>Name</i> ainsi que votre adresse couriel dans le champs <i>Email address</i> et cliquer sur <i>Get activation code and start Visual Paradigm</i> afin de recevoir votre code d'activation.</p>
	<img alt="Inscription" src="../ressources/images/visualParadigm/linux/linux_inscription.png"/>
	<p>Aller chercher votre code d'activation dans votre boître messagerie à l'adresse entrée précédament et cliquer sur <i>Activate</i>.</p>
	<img alt="Réception du code d'activation" src="../ressources/images/visualParadigm/linux/linux_code.png"/>
	<p>Entrer votre code d'activation ainsi que votre nom. Cliquer sur <i>Activate</i>.</p>
