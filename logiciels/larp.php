...
<h2><a name="presentation">Présentation</a></h2>
    ...
    en francais, facile d'utilisation et permet de visualiser des structures algorithmique grâce à 
...
<h3><a name="windows-telechargement">Téléchargement</a></h3>
    ...
    <p>Depuis le premier mars 2008, LARP est devenu disponible en version gratuiciel. Afin d'obtenir plus de détail sur les licenses d'utiliation, 
...
<h3><a name="windows-installation">Procédure d'installation</a></h3>
    ...
    <p>Veuillez lire attentivement le contrat de license et ensuite, sélectionnez l'option illustrant que vous comprenez et acceptez les termes 
    ...
    <p>Veuillez lire les informations émises sur la fenêtre suivante et une fois cela fait, cliquer sur <i>"Suivant >"</i>.</p>
    <img alt="informations" src="../ressources/images/larp/larp-5.png"/>
    <p>En cliquant sur le bouton "parcourir" le programme vous laisse sélectionner une destination d'installation possèdant un espace libre 
    ...
    <p>Les options de tâches supplémentaires affichés vous permettent de sélectionner si vous souhaitez 
    ...
    <p>Une fois terminé, la fenêtre suivante devrait apparaitre. Cliquez sur "Terminer" afin de finaliser l'installation.</p>
...
<h3><a name="linux-prealables">Préalables</a></h3>
    <p>Veuillez noter que LARP à été développé pour les systèmes Windows seulement. Par contre, il est possible de l'installer à l'aide 
    des logiciels comme Wine (L'installation de Wine n'est pas décrite dans ce guide).</p>
<h3><a name="linux-installation">Procédure d'installation</a></h3>
    ...
    <p>Pour le reste de l'installation, référez-vous à l'installation sur Windows, puisqu'elle s'effectue exactement de la même manière 
    que mentionné <a href="#choix">ici</a>.</p>
